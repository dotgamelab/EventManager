...
public class EventManager : Singleton<EventManager>
{
    ...
    ///  Call all the functions registerd to the event system
    /// </summary>
    public void TriggerEvent<T, U>(string functionName, T data1, U data2)
    {
    ...
    /// Call all the functions registerd to the event system
    /// </summary>
    public void TriggerEvent<T, U, V>(string functionName, T data1, U data2, V data3)
    {
    ...
    /// Call all the functions registerd to the event system
    /// </summary>
    public void TriggerEvent<T, U, V, Y>(string functionName, T data1, U data2, V data3, Y data4)
    {
    ...
    /// Call all the IEnumerator Coroutines that you want to run by event system
    /// </summary>
    public void TriggerEvent_StartCoroutine<T>(Component sender, string functionName, T data)
    {
        if (AddToListener_Coroutine_1_Param == null)
        {
            Debug.Log("Null Ref : No Registered Function Name Like " + functionName + " In Any Gameobject.");
